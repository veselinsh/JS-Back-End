...
router.post('/register',
    ...
    body('username')
        ...
        .isAlphanumeric().withMessage('Username must be wonly with alphanumeric characters'),
    body('password')
        .isLength({ min: 3 }).withMessage('Password must be at least 8 characters long')
        .isAlphanumeric().withMessage('Password must be wonly with alphanumeric characters'),
    body('repeatPassword')
